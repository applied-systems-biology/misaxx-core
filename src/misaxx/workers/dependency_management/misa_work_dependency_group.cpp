...
misa_work_dependency_group::misa_work_dependency_group(misaxx::misa_worker_base &t_worker) : m_as_dependencies( { t_worker.get_node() } ) {
...
void misa_work_dependency_group::assign(std::shared_ptr<misaxx::nodes::misa_work_node> t_node) {
    if(m_locked) {
